...
(custom-theme-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "#6B2E80"))))
 '(font-lock-comment-delimiter-face ((t (:inherit (font-lock-comment-face) :foreground "#B09900" :background "#737C9E"))))
 '(font-lock-comment-face ((t (:slant italic :foreground "#827100" :background "#919DCC"))))
 '(font-lock-constant-face ((t (:foreground "#00BD23" :weight bold))))
 '(font-lock-doc-face ((t (:inherit (font-lock-string-face)))))
 '(font-lock-function-name-face ((t (:foreground "#588A30"))))
 '(font-lock-keyword-face ((t (:foreground "#F22469"))))
 '(font-lock-negation-char-face ((t nil)))
 '(font-lock-preprocessor-face ((t (:inherit (font-lock-builtin-face)))))
 '(font-lock-regexp-grouping-backslash ((t (:inherit (bold)))))
 '(font-lock-regexp-grouping-construct ((t (:inherit (bold)))))
 '(font-lock-string-face ((t (:foreground "#838A00"))))
 '(font-lock-type-face ((t (:foreground "#77117A"))))
 '(font-lock-variable-name-face ((t (:foreground "#25367D"))))
 ...
 '(default ((t (:inherit nil :background "#ADC6FF" :foreground "#1C1C1C" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 100)))))
